...
//!
//! ```
//! use units::scalar::{Kilogram, Mass, SolarMass};
//!
...
//!
//! ```compile_fail
//! use units::scalar::{Kilo, Mass, Prefixed, SolarMass};
//!
...
//!
//! ```compile_fail
//! use units::scalar::{Kilo, Kilogram, Mass, Prefixed};
//!
...
//!
//! ```compile_fail
//! use units::scalar::{Mass, SolarMass};
//!
