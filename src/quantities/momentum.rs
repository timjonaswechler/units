...
define_composed_unit!(SolarMassAUPerYear, "M☉⋅AU/yr", 1.989e30 * 1.496e11 / 31_557_600.0); // ~9.42e33 kg⋅m/s
...
define_composed_unit!(ElectronMassSpeedOfLight, "m_e⋅c", 9.1094e-31 * 299_792_458.0); // Electron rest momentum
...
impl_quantity_constructors!(
    Momentum,
    KilogramMeterPerSecond, NewtonSecond,
    GramCentimeterPerSecond, GramMeterPerSecond,
    TonneMeterPerSecond, KilogramKilometerPerSecond,
    ElectronVoltPerSpeedOfLight, MegaElectronVoltPerSpeedOfLight, 
    GigaElectronVoltPerSpeedOfLight, TeraElectronVoltPerSpeedOfLight,
    SolarMassAUPerYear, EarthMassKilometerPerSecond, LunarMassKilometerPerSecond,
    AtomicMassUnitMeterPerSecond, ElectronMassSpeedOfLight,
