...
impl_quantity_constructors!(
    Density,
    KilogramPerCubicMeter, GramPerCubicCentimeter, GramPerCubicMeter, TonnePerCubicMeter,
    GramPerCubicCentimeterCGS, SolarDensity, WaterDensity,
    WhiteDwarfDensity, NeutronStarDensity, NuclearDensity,
    InterstellarDensity, MolecularCloudDensity,
    EarthDensity, AirDensity
);
