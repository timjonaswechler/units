...
// Dimensional arithmetic implementations are now in the arithmetic module
// This provides a cleaner, macro-based system that eliminates hard-coded operations
