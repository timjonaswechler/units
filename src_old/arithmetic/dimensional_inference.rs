//! Automatic dimensional inference for arithmetic operations.
//!
//! This module provides the macro-based system for generating arithmetic operations
...
// Export the macros for external use
pub(crate) use impl_dimensional_mul;
pub(crate) use impl_dimensional_div;